        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto" id="navigation">
                    ...
                    <a href="javascript:void(0)" onclick="building();" class="nav-item nav-link">療程介紹</a>
                    <a href="javascript:void(0)" onclick="building();" class="nav-item nav-link">美麗見證</a>
                    <a href="javascript:void(0)" onclick="building();" class="nav-item nav-link">醫師專欄</a>
