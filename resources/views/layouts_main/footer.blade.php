    ...
    <div class="container py-5">
        <div class="row g-5 justify-content-around">
            <div class="col-lg-3 col-md-6 align-self-center">
                <a href="{{ route('index') }}">
                    <img data-src="{{ asset('images/logo_full_white.png') }}"
                        src="{{ asset('images/logo_full_white.png') }}" class="lazy" alt="">
                </a>
                <div class="d-flex pt-3 mb-3">
                    <a class="btn btn-square btn-primary rounded-circle me-2" href="{{ $contact->company_line }}"
                        target="_blank"><i class="fab fa-line"></i></a>
                    <a class="btn btn-square btn-primary rounded-circle me-2" href="{{ $contact->company_facebook }}"
                        target="_blank"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-square btn-primary rounded-circle me-2" href="{{ $contact->company_youtube }}"
                        target="_blank"><i class="fab fa-youtube"></i></a>
                    <a class="btn btn-square btn-primary rounded-circle me-2" href="{{ $contact->company_instagram }}"
                        target="_blank"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <h2 class="text-white mb-4">診所資訊</h2>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary me-3"></i><a class="text-light"
                        href="{{ $contact->company_map_url }}" target="_blank">{{ $contact->company_address}}</a>
                </p>
                <p class="mb-2"><i class="fa fa-phone-alt text-primary me-3"></i><a class="text-light"
                        href="tel:{{ $contact->company_phone }}">{{ $contact->company_phone }}</a></p>
                ...
                <p class="mb-1">週五營業時間 11:00-21:00</p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link" href="{{ route('international') }}">海外專區</a>
            </div>
        </div>
    </div>
</div>
