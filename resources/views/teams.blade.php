                            ...
                            <div class="col-xl-3 col-md-6 col-lg-3  mb-5">
                                ...
                                <div class="single_team text-center position-relative">
                                    <div class="team_thumb position-relative z-2"
                                        ...
                                        <img data-src="{{ env('APP_URL', 'https://museebeaux.com') . '/uploads/' . $team->headshots }}"
                                        src="{{ env('APP_URL', 'https://museebeaux.com') . '/uploads/' . $team->headshots }}" class="img-fluid w-d-75 lazy"
