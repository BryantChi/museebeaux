                            ...
                            <div class="col-lg-5 align-self-center">
                                <div class="single_dream text-center">
                                    <div class="thumb position-relative px-2">
                                        ...
                                        src="{{ $service->service_cover_front ?? null ? env('APP_URL', 'https://museebeaux.powerchi.com.tw') . '/uploads/' . $service->service_cover_front : asset('images/services/services-01.webp') }}"
