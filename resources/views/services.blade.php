                            ...
                            <div class="col-lg-5 align-self-center">
                                <div class="single_dream text-center">
                                    <div class="thumb position-relative px-2">
                                        <img data-src="{{ $service->service_cover_front ?? null ? env('APP_URL', 'https://museebeaux.com') . '/uploads/' . $service->service_cover_front : asset('images/services/services-01.webp') }}"
                                        src="{{ $service->service_cover_front ?? null ? env('APP_URL', 'https://museebeaux.com') . '/uploads/' . $service->service_cover_front : asset('images/services/services-01.webp') }}"
                    ...
                    <div class="col-xl-4 col-md-4 my-5 serives-items">
                        <div class="single_dream text-center">
                            <div class="thumb position-relative">
                                <img src="{{ $service->service_cover_front ?? null ? env('APP_URL', 'https://museebeaux.com') . '/uploads/' . $service->service_cover_front : asset('images/services/services-01.webp') }}"
