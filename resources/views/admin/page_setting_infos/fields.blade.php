    ...
    <div id="dynamicField">
        ...
        <div class="mt-2 field-group card p-4 bg-light-subtle">
            ...
            <div class="img-preview mt-2">
                <p for="">PC</p>
                <img src="{{ env('APP_URL', 'https://museebeaux.com'). '/uploads/' . $banner }}" style="max-width: 200px; max-height: 200px;">
            </div>
            <div class="img-preview-mob mt-2">
                <p for="">Mobile</p>
                <img src="{{ env('APP_URL', 'https://museebeaux.com'). '/uploads/' . ($pageSettingInfo->banner_mob[$i] ?? '') }}"
